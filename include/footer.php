      ...
      <div class="col-12 col-md-6 col-lg-2  footer-col">
        ...
        <div class="footer-col-content-wrapper">
          <ul class="footer-menu ">
            ...
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="policies.php">Policies</a>
            </li>
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="pricing.php">Pricing Plans</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-12 col-md-6 col-lg-2 footer-col">
        <h2 class=" footer-col-title    ">Our Services</h2>
        <div class="footer-col-content-wrapper">
          <ul class="footer-menu">
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="services.php">Standard Services</a>
            </li>
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="movein-moveout.php">Move-In/Move-Out Cleaning</a>
            </li>
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="post-construction.php">Post Construction</a>
            </li>
          </ul>
        </div>
      </div>
...
Lynnwood, WA – 98036
  ...
  <div class="copyrights ">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="creadits text-center">&copy; 2022 Created by: <a class="link" href="https://umairabbas.me">Umair Abbas</a>
          </p>
        </div>
      </div>
    </div>
