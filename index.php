...
<section class="about mega-section" id="about">
    <div class="container">
        ...
        <div class="content-block  ">
            <div class="row">
                <div class="col-12 col-lg-6 d-flex align-items-center about-col">
                    <div class="img-area  ">
                        <!-- <div class="photo-banner-start"><span class="number">46          </span>
                  <p class="banner-text">years of Exprince</p><i class="flaticon-channel banner-icon"></i>
                </div> -->
                        <div class="image ">
                            <div class="overlay-color"></div><img class="about-img parallax-img  img-fluid "
                                src="assets/Images/about/1.jpg" alt="Our vision">
                        </div>
                ...
                <div class="col-12 col-lg-6 d-flex align-items-center about-col pad-start">
                    <div class="text-area ">
                                ...
                                <div class="col-12 ">
                                    <ul class="menu-items">
                                        ...
                                        <li class="info-item"><i class="flaticon-cleaning info-icon"></i>
                                            <div class="info-content">
                                                <h5 class="info-title">No Contracts</h5>
                                                <p class="info-text">We require no contracts for on going service.
                                                    Cancel or put your service on hold at anytime.</p>
                                            </div>
                                        </li>
    ...
    <div class="container">
        ...
        <div class="row gx-4 gy-4 services-row">
            <div class="col-12 col-md-9  col-lg-4 mx-auto">
                ...
                <div class="service-box featured" data-tilt="data-tilt" style="height:280px!important;">
...
<section class="testimonials stack has-dark-bg  dark-cards testimonials-2-col bg-img-section   mega-section "
    id="testimonials">
    <div class="overlay-photo-image-bg  " data-bg-img="assets/Images/testimonials/testmonials-bg.jpg"
        data-bg-opacity="1"></div>
    <div class="overlay-pattern-image-bg  " data-bg-img="assets/Images/sections-bg-images/pattern-bg.jpg"
        data-bg-opacity=".085"></div>
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-12 col-lg-4 ">
                <div class="sec-heading  light-title mb-4 ">
                    <div class="content-area"><span class=" pre-title        " data-wow-delay=".2s">testmonials</span>
                        <h2 class=" title    ">Customers Feedback about their experience with us</h2>
                    </div>
                </div>
            </div>
        ...
        <!--Start .see-more-area-->
        <div class=" see-more-area d-block d-lg-none  text-center" data-wow-delay="0.4s"><a class=" btn-solid "
                href="#0">see all testimonials</a></div>
...
<section class="faq mega-section" id="faq">
    ...
    <div class="container">
        ...
        <div class="faq-accordion  " id="accordion" data-wow-delay="0.4s">
            <div class="row">
                <div class="col-12 col-lg-6">
                        ...
                        <div class="card-header " id="heading-1">
                            <h5 class="mb-0 faq-title">
                                <button class="btn btn-link  faq-btn collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1"> How does payment work?</button>
                            </h5>
                        </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-header " id="heading-2">
                            <h5 class="mb-0 faq-title">
                                <button class="btn btn-link  faq-btn  collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-2" aria-expanded="true" aria-controls="collapse-2"> Do you background check employees?</button>
                            </h5>
                        </div>
                        <div class="collapse  " id="collapse-2" aria-labelledby="heading-2" data-parent="#accordion">
                            <div class="card-body">
                                <p class="faq-answer">
                                Yes, we run a criminal background check on every employee.
                    ...
                    <div class="card mb-2">
                        <div class="card-header " id="heading-3">
                            <h5 class="mb-0 faq-title">
                                <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse"
                                    data-bs-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3"> Will I get the same cleaners?</button>
                            </h5>
                        </div>
                        <div class="collapse " id="collapse-3" aria-labelledby="heading-3" data-parent="#accordion">
                            <div class="card-body">
                                <p class="faq-answer">
                                If having the same cleaner is something you prefer please let us know and we can at least guarantee one of the same cleaners each time. We try our hardest to send the same cleaners but occasionally it is not possible do to scheduling.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="card mb-2">
                        <div class="card-header " id="heading-4">
                            <h5 class="mb-0 faq-title">
                                <button class="btn btn-link  faq-btn collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4"> Can I leave while the house cleaners are at my home?</button>
                            </h5>
                        </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-header " id="heading-5">
                            <h5 class="mb-0 faq-title">
                                <button class="btn btn-link  faq-btn  collapsed" data-bs-toggle="collapse"
                                    data-bs-target="#collapse-5" aria-expanded="true" aria-controls="collapse-5">What if I am not satisfied with the job?</button>
                            </h5>
                        </div>
                        <div class="collapse  " id="collapse-5" aria-labelledby="heading-5" data-parent="#accordion">
                            <div class="card-body">
                                <p class="faq-answer">
                                We guarentee our work! If you are not happy with the service you ordered we will come back to fix it free of charge!
